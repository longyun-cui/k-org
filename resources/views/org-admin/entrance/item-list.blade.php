        ...
        <div class="box box-info">
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                ...
                <div class="pull-right">
                    <a href="{{url('/org-admin/item/create')}}">
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            else if(data == 11) return '<small class="label bg-purple">活动</small>';
                            else if(data == 99) return '<small class="label bg-green">赞助广告</small>';
...
//                            var share_follow_html = '<li><a class="item-share-submit" data-id="'+data+'" data-share="41">转为-关注者可见</a></li>';
                            ...
                            var html =
                                ...
                                '</button>'+
                                '<ul class="dropdown-menu" role="menu">'+
                                '<li><a href="/org-admin/item/edit?id='+data+'">编辑</a></li>'+
//                                '<li><a href="/org-admin/item/content?id='+data+'">内容管理</a></li>'+
                                shared_html+
//                                active_html+
