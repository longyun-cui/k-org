...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include('org-admin.component.main-header')

    {{--main-sidebar--}}
    @include('org-admin.component.main-sidebar')

    {{--main-content--}}
    @include('org-admin.component.main-content')

    {{--main-footer--}}
    @include('org-admin.component.main-footer')

    {{--control-sidebar--}}
    @include('org-admin.component.control-sidebar')
