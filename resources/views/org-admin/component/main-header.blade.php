...
<header class="main-header">
    ...
    <a href="{{url('/home')}}" class="logo">
        ...
        <span class="logo-lg"><b>朝鲜族</b></span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown tasks-menu add-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header"><a href="{{ url('/org-admin/item/create') }}"><i class="fa fa-plus text-red"></i>添加内容</a></li>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        @if(!empty(Auth::guard('org_admin')->user()->portrait_img))
                            <img src="{{ url(env('DOMAIN_CDN').'/'.Auth::guard('org_admin')->user()->portrait_img) }}" class="user-image" alt="User Image" />
                        @else
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                {{ Auth::guard('org_admin')->user()->nickname }}
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="/org-admin/admin/info" class="btn btn-default btn-flat">管理员资料</a>
                            </div>
                            <div class="pull-right">
                                <a href="/org-admin/logout" class="btn btn-default btn-flat user-logout">退出</a>
                            </div>
                        </li>
                    </ul>
                </li>
