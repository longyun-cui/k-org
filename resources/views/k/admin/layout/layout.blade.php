...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_ADMIN').'admin.component.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_ADMIN').'admin.component.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_ADMIN').'admin.component.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_ADMIN').'admin.component.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_ADMIN').'admin.component.control-sidebar')
