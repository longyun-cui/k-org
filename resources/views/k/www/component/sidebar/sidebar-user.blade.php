<ul class="sidebar-menu">
    ...
    <li class="treeview {{ $menu_active_for_item_all or '' }}">
    ...
    <li class="treeview {{ $menu_active_for_introduction or '' }}">
    ...
    <li class="treeview {{ $menu_active_for_item_article or '' }}">
    ...
    <li class="treeview {{ $menu_active_for_item_activity or '' }}">
    ...
    <li class="treeview {{ $menu_active_for_or or '' }}">
