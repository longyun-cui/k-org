...
<div class="right-piece- box-body bg-white margin-bottom-4px section-user radius-2px">
    ...
    <div class="box box-widget widget-user">
        ...
        <div class="widget-user-header bg-aqua-active">
            {{--<h3 class="widget-user-username text-center" style="font-size:18px;"><b>{{ $data->username or '' }}</b></h3>--}}
        ...
        <div class="widget-user-image">
            {{--<a href="{{ url('/user/'.$data->id) }}">--}}
                <img src="{{ url(env('DOMAIN_CDN').'/'.$data->portrait_img) }}" class="img-circle" alt="User Image">
            {{--</a>--}}
        </div>


        {{--主要信息--}}
        <div class="_none-" style="margin-bottom:16px;">
    ...
    <div class="box box-widget widget-user _none">
        <div class="box-footer">
            <div class="row">
                <div class="col-xs-4 col-sm-4 border-right">
                    <a href="{{ url('/user/'.$data->id) }}">
...
<style>
    ...
    .widget-user .widget-user-header { height:60px; }
    .widget-user .widget-user-image { position:relative; top:0; margin-top:-30px; margin-left:-40px; margin-bottom:16px; }
    ...
    .list-group-item { padding:4px 12px; border:1px solid #eeeeee; }
