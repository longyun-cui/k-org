...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_ADMIN').'sponsor.component.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_ADMIN').'sponsor.component.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_ADMIN').'sponsor.component.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_ADMIN').'sponsor.component.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_ADMIN').'sponsor.component.control-sidebar')
