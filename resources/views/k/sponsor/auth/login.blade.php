@extends(env('TEMPLATE_ADMIN').'sponsor.layout.auth')

@section('title','赞助商登陆 - 如未科技')

@section('content')
<div class="login-box">
    <div class="login-logo">
        <a href="/sponsor"><b>{{ config('common.name') }}</b> 朝鲜族组织活动平台</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">赞助商后台登陆</p>
