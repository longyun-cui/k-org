...
<header class="main-header">
        ...
        <a href="{{ url('/org') }}" class="logo">
            ...
            <span class="logo-lg"><b>赞助商后台</b></span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            @if(Auth::guard('sponsor')->user()->portrait_img)
                                <img src="{{ url(env('DOMAIN_CDN').'/'.Auth::guard('sponsor')->user()->portrait_img) }}" class="user-image" alt="User Image">
                            @else
                                <img src="/AdminLTE/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                            @endif
                            <!-- hidden-xs hides the username on small devices so only the image appears. -->
                            <span class="hidden-xs">{{ Auth::guard('sponsor')->user()->username }}</span>
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{ Auth::guard('sponsor')->user()->username }} - 管理员
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url('/sponsor/info/index') }}" class="btn btn-default btn-flat">基本资料</a>
                                </div>
                                <div class="pull-right">
                                    <a href="{{ url('/sponsor/logout') }}" class="btn btn-default btn-flat">退出</a>
                                </div>
                            </li>
                        </ul>
                    </li>
