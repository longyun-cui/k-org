...
@section('head_title','粉丝列表 - 赞助商后台管理系统 - 朝鲜族组织活动平台 - 如未科技')
            ...
            <div class="box box-info">
                ...
                <div class="box-header with-border" style="margin:16px 0;">
                    ...
                    <div class="caption pull-right _none">
                        ...
                        <a href="{{ url('/sponsor/user/fans-create') }}">
                            <button type="button" onclick="" class="btn btn-success pull-right"><i class="fa fa-plus"></i> 添加粉丝</button>
                        </a>
                    </div>
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                    ...
                    "searching": false,
                    "ajax": {
                        'url': "{{ url('/sponsor/user/my-fans-list') }}",
                        "type": 'POST',
                        "dataType" : 'json',
                        "data": function (d) {
...
//                $('select.form-filter').selectpicker('refresh');
            ...
            $("#item-main-body").on('click', ".item-download-qr-code-submit", function() {
                var that = $(this);
                window.open("/download-qr-code?sort=item&id="+that.attr('data-id'));
            });
