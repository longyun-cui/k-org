@extends(env('TEMPLATE_K_ORG').'layout.auth')

@section('title','组织登陆 - 如未科技')
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <div class="row _none" style="margin-top:16px;">
            <div class="col-sm-12">
                <a href="{{ url(env('DOMAIN_WWW').'/org-register') }}" class="text-center">注册新组织</a>
            </div>
        </div>

        <div class="row" style="margin-top:8px;">
            <div class="col-sm-12">
                <a href="{{ url(env('DOMAIN_WWW')) }}" class="text-center">返回平台首页</a>
            </div>
        </div>
