...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_K_ORG').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_K_ORG').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_K_ORG').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_K_ORG').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_K_ORG').'layout.control-sidebar')
...
@include(env('TEMPLATE_K_ORG').'layout.layout-script')
