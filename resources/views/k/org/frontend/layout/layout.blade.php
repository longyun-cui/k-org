...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="{{ env('FAVICON_K_ORG') }}">
    <link rel="shortcut icon" type="image/png" href="{{ env('FAVICON_K_ORG') }}">
    <link rel="icon" sizes="16x16 32x32 64x64" href="{{ env('FAVICON_K_ORG') }}">
    <link rel="icon" type="image/png" sizes="196x196" href="{{ env('FAVICON_K_ORG') }}">
...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_K_ORG_FRONT').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_K_ORG_FRONT').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_K_ORG_FRONT').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_K_ORG_FRONT').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_K_ORG_FRONT').'layout.control-sidebar')
...
@include(env('TEMPLATE_K_ORG_FRONT').'layout.layout-script')
