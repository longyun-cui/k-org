...
<div class="wrapper main-body-ctn">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_K_ORG_ADMIN').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_K_ORG_ADMIN').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_K_ORG_ADMIN').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_K_ORG_ADMIN').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_K_ORG_ADMIN').'layout.control-sidebar')
