...
@section('head_title','粉丝列表 - 组织后台管理系统 - 朝鲜族组织活动平台 - 如未科技')
        ...
        <div class="box box-info">
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                ...
                <div class="caption pull-right _none">
                    ...
                    <a href="{{ url('/org/user/fans-create') }}">
...
@include(env('TEMPLATE_K_ORG_ADMIN').'entrance.user.user-script')
@endsection
