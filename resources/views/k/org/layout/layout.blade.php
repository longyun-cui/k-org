...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_ADMIN').'org.component.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_ADMIN').'org.component.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_ADMIN').'org.component.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_ADMIN').'org.component.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_ADMIN').'org.component.control-sidebar')
