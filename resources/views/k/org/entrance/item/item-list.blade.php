...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "searching": false,
                "ajax": {
                    'url': "{{ url('/org/item/item-list?type='.request('type')) }}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
...
//                                    '<a class="btn btn-xs item-disable-submit" data-id="'+data+'">禁用</a>'+
                                    ...
                                    '<a class="btn btn-xs item-statistic-submit" data-id="'+data+'">流量统计</a>'+
                                    $html_2+
                                    '';
                            return html;
                        }
...
@include(env('TEMPLATE_ADMIN').'org.entrance.item.item-script')
@endsection
