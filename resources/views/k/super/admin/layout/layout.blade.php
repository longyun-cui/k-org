...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_K_SUPER_ADMIN').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_K_SUPER_ADMIN').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_K_SUPER_ADMIN').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_K_SUPER_ADMIN').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_K_SUPER_ADMIN').'layout.control-sidebar')
...
{{--layout-script--}}
@include(env('TEMPLATE_K_SUPER_ADMIN').'layout.layout-script')
