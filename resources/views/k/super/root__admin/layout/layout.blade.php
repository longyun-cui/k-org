...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="{{ env('FAVICON_K_SUPER') }}">
    <link rel="shortcut icon" type="image/png" href="{{ env('FAVICON_K_SUPER') }}">
    <link rel="icon" sizes="16x16 32x32 64x64" href="{{ env('FAVICON_K_SUPER') }}">
    <link rel="icon" type="image/png" sizes="196x196" href="{{ env('FAVICON_K_SUPER') }}">
...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_K_SUPER__ADMIN').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_K_SUPER__ADMIN').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_K_SUPER__ADMIN').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_K_SUPER__ADMIN').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_K_SUPER__ADMIN').'layout.control-sidebar')
...
{{--layout-script--}}
@include(env('TEMPLATE_K_SUPER__ADMIN').'layout.layout-script')
