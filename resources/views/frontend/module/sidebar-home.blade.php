...
<div class="main-side-block main-side-container text-center">
    ...
    <ul>
        ...
        <li class="{{ $root_mine_active or '' }}">
            <a href="{{ url('/') }}">
                <div class="box-body main-side-hover row-ellipsis" title="{{ Auth::user()->name }}">
                    {{ Auth::user()->name }}
                </div>
            </a>
        </li>
    ...
    <ul class="">
        ...
        <li class="{{ $item_list_root_active or '' }}">
            <a href="{{ url('/') }}">
                <div class="box-body main-side-hover">
                    平台首页
                </div>
        ...
        <li class="{{ $item_list_all_active or '' }}">
        ...
        <li class="{{ $item_list_activity_active or '' }}">
        ...
        <li class="{{ $item_list_article_active or '' }}">
