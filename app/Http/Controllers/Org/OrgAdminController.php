...
use App\Repositories\Org\OrgAdminRepository;
...
class OrgAdminController extends Controller
{
    ...
    {
        $this->repo = new OrgAdminRepository;
    }
...
//            return view('mt.admin.entrance.user.client-list')->with(['sidebar_client_list_active'=>'active menu-open']);
    ...
    // 【公告】返回-列表-视图
    public function show_notification_all_list()
    {
        if(request()->isMethod('get')) return $this->repo->show_notification_all_list(request()->all());
